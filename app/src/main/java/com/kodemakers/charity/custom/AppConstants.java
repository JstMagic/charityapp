...
public class AppConstants {
    ...
    public static final String FORGOT_PASSWORD = BASE_URL + "forgot_password_charity.php";
    public static final String ADD_INTRO_SLIDER = BASE_URL + "add_intro_steppers.php";
